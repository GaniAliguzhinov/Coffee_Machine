...
public class CoffeeMachine {
    ...
    private final String STR_PROMPT_CHOICE = "What do you want to buy? 1 - espresso, 2 - latte, 3 - cappuccino, back - to main menu:\n> ";

    private final String STR_PROMPT_WATER = "Write how many ml of water do you want to add:\n> ";
    private final String STR_PROMPT_MILK = "Write how many ml of milk do you want to add:\n> ";
    private final String STR_PROMPT_BEANS = "Write how many grams of coffee beans do you want to add:\n> ";
    private final String STR_PROMPT_CUPS = "Write how many disposable cups of coffee do you want to add:\n> ";

    private final String STR_TAKE = "I gave you $";
